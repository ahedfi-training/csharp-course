...
namespace DbFirst
{
    ...
    public partial class LiveDemoEntities : DbContext
    {
        public LiveDemoEntities()
            : base("name=LiveDemoEntities")
        {
        }
        ...
        [DbFunction("LiveDemoEntities", "GetAuthorCourses")]
        public virtual IQueryable<funcGetAuthorCourses_Result> GetAuthorCourses(Nullable<int> authorID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<funcGetAuthorCourses_Result>("[LiveDemoEntities].[GetAuthorCourses](@AuthorID)", authorIDParameter);
        }
